...
# CompressedStaticFilesStorage avoids .map file errors from third-party packages
...
JAZZMIN_SETTINGS = {
    ...
    "site_brand": "InvStock",
    "welcome_sign": "Welcome to Inventory Management",
    "copyright": "InvStock 2024",
    "search_model": ["auth.user", "inventory.product", "inventory.order"],
    "topmenu_links": [
    ...
    "icons": {
        ...
        "forecasting.forecast": "fas fa-chart-line",
    },
